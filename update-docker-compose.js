...
async function updateDockerCompose() {
  try {
    ...
    // Add Supabase environment variables to backend service
    ...
    // Add Supabase environment variables to frontend service
    dockerCompose = dockerCompose.replace(
      '      - NODE_ENV=production',
      '      - NODE_ENV=production\n      - NEXT_PUBLIC_SUPABASE_URL=https://supabasekong-akowwgwwwwcwossg4cgwk0ok.m2w.io:8000\n      - NEXT_PUBLIC_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5ODM4MTI5OTZ9.CRXP1A7WOeoJeXxjNni43kdQwgnWNReilDMblYTn_I0'
    );
